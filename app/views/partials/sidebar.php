...
<aside id="sidebar"
    class="fixed inset-y-0 left-0 w-64 bg-white shadow-lg flex flex-col justify-between z-50 transform -translate-x-full md:translate-x-0 transition-transform duration-300">
