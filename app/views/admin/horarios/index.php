...
<head>
  <meta charset="UTF-8">
  <title>Horarios | Masuno Admin</title>
...
<body class="flex min-h-screen bg-gray-100 text-black">
  ...
  <main class="flex-1 ml-64 p-8 overflow-auto">
    <div class="flex items-center justify-between mb-6">
      <h1 class="text-2xl font-bold">Gesti&oacute;n de Horarios</h1>
      <a href="index.php?url=Horario/create"
    ...
    <table class="mt-4 w-full bg-white shadow rounded">
      ...
      <tbody>
        ...
        <tr class="hover:bg-gray-50">
          <td class="border px-4 py-2"><?= htmlspecialchars($h->fecha) ?></td>
          <td class="border px-4 py-2"><?= htmlspecialchars($h->hora_inicio) ?></td>
          <td class="border px-4 py-2"><?= htmlspecialchars($h->hora_fin) ?></td>
  ...
  <div id="delete-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden">
    <div class="bg-white rounded-lg shadow-lg p-6 w-80">
      ...
      <p class="mb-6">&iquest;Est&aacute;s seguro de eliminar este horario?</p>
