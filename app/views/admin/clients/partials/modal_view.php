<div id="view-modal"
    ...
    <div class="bg-white rounded-xl shadow-2xl p-6 w-full max-w-md mx-4 relative transform scale-100">
        ...
        <div class="text-center mb-6">
            <div class="h-24 w-24 bg-indigo-50 rounded-full flex items-center justify-center text-indigo-600 text-4xl font-bold mx-auto mb-3 border-4 border-white shadow-md overflow-hidden"
                id="view-avatar">
            </div>

            <h3 class="text-xl font-bold text-gray-900" id="view-nombre">Cargando...</h3>
