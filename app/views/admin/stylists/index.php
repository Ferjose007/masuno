...
<head>
  <meta charset="UTF-8">
  <title>Estilistas | Masuno Admin</title>
...
<main class="flex-1 ml-64 p-8 overflow-auto">
    <div class="flex items-center justify-between mb-6">
      <h1 class="text-2xl font-bold">Gestión de Estilistas</h1>
  ...
  <div id="delete-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden">
    <div class="bg-white rounded-lg shadow-lg p-6 w-80">
      ...
      <p class="mb-6">&iquest;Est&aacute;s seguro de eliminar este estilista?</p>
